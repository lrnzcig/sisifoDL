...
class Test0(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        names = np.array(['h_17-04-27', 'h_17-04-28', 'p_17-01-19', 'p_17-01-20',
                          'p_17-01-21', 'p_17-01-22', 'p_17-01-23', 'p_17-01-24',
                          'p_17-01-25', 'p_17-01-26', 'p_17-01-27', 'p_17-01-28',
                          'p_17-01-29', 'p_17-01-30', 'p_17-01-31', 'p_17-02-01',
                          'p_17-02-02', 'p_17-02-03', 'p_17-02-04', 'p_17-02-05',
                          'p_17-02-06', 'p_17-02-07', 'p_17-02-08', 'p_17-02-09',
                          'p_17-02-10', 'p_17-02-11', 'p_17-02-12', 'p_17-02-13',
                          'p_17-02-14', 'p_17-02-15', 'p_17-02-16', 'p_17-02-17',
                          'p_17-02-18'])
                          """
        self.names = np.array(['h_17-04-27', 'h_17-04-28', 'p_17-01-19', 'p_17-01-20'])
        self.batch_size = 3
    ...
    def test_generator(self):
        ...
        #print(X_second_last)
        #print(self.dataset_reduced_std[self.dataset_reduced_std["name"] == 'p_17-01-20'][-21:])
        #print(y_second_last)
        ...
        with open('./test_data/y_second_last.pkl', 'rb') as f:
        ...
        #print(X_last)
        #print(self.dataset_reduced_std[self.dataset_reduced_std["name"] == 'p_17-01-20'][-20:])
        #print(y_last)

        with open('./test_data/X_last.pkl', 'rb') as f:
            X_last_ref = pd.read_pickle(f)
        self.assertTrue((X_last_ref == X_last).all())
        with open('./test_data/y_last.pkl', 'rb') as f:
